const BLOG = {
  ...
  darkBackground: '#0d004d', // use hex value, don't forget '#'
  ...
  socialLink: 'https://mobile.twitter.com/tuitejiushifjb',
  seo: {
  ...
  comment: {
    ...
    cusdisConfig: {
      appId: 'b9bf5b05-9685-4e93-98c0-745889bb8b73', // data-app-id
